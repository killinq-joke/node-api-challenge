...
how to make endpoints, middleware and how to make routes


- [x] Describe Middleware?

Middleware are functions that trigger in the middle of some other function

- [x] Describe a Resource?

a resource is something that you can pull from a database
...
we can make monoliths that contain the backend & the frontend of an application
